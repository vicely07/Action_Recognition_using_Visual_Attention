...
def main():
    video_path = '/home/vicely07/FallDetectionSystem/LSTM/video/'
    data_path = '/home/vicely07/FallDetectionSystem/LSTM/data/'
    folders = ['a01', 'a02', 'a03', 'a04', 'a05', 'a06', 'a07', 'a08', 'a9', 'a10', 'a11']
    ...
    label_to_idx = {"biking": 0, "diving": 1, "golf": 2, "juggle": 3, "jumping": 4, "riding": 5, "shooting": 6, "spiking": 7, "swing": 8, "tennis": 9, "walk_dog": 10}
    save_pickle(label_to_idx, data_path + '/data/label_to_idx.pkl')
